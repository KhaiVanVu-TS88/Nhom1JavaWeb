                                ...
                                <div class="row align-items-center">
                                    <div class="col-12 col-md-5 col-lg-6 order-md-2 ">
                                        <div class="text-center p-4">
                                            <img src="${pageContext.request.contextPath}/dist/assets/images/task-view.svg" alt="${pageContext.request.contextPath}." class="img-fluid">
                                        </div>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card bg-primary">
                            <div class="card-body text-white d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column ms-3">
                                    <h6 class="mb-0">Khóa học sắp mở</h6>
                    ...
                    <div class="col">
                        <div class="card bg-primary">
                            <div class="card-body text-white d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column ms-3">
                                    <h6 class="mb-0">Khóa học đang tiến hành</h6>
                    ...
                    <div class="col">
                        <div class="card bg-primary">
                            <div class="card-body text-white d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column ms-3">
                                    <h6 class="mb-0">Khóa học đã hoàn thành</h6>
						...
						<div class="col-md-12">
							<div class="card mb-3">
								<div
									class="card-header py-3 d-flex justify-content-between align-items-center">
									<div class="info-header">
										<h6 class="mb-0 fw-bold ">Thông tin khóa học</h6>
									</div>
								</div>
								<div class="card-body">
									<table id="myProjectTable"
										...
										<thead>
											<tr>
												...
												<th>Tiến độ</th>
												<!--(khóa học đã hoàn thành bao nhiêu phần trăm)-->
										...
										<tbody>
											<tr>
												...
												<td><img
													src="${pageContext.request.contextPath}/dist/assets/images/xs/avatar1.jpg"
													alt="Avatar" class="avatar sm  rounded-circle me-2"><a
													href="#">Keith</a></td>
												<td>
													<div class="progress">
