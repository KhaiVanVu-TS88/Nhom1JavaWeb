...
<title>Đăng ký</title>
<link rel="icon"
	href="${pageContext.request.contextPath}/dist/favicon.ico"
	type="image/x-icon">
<!-- Favicon-->
<!-- project css file  -->
<link rel="stylesheet"
						...
						<div
							...
							<div style="max-width: 25rem;">
								<div class="text-center mb-5">
									<svg width="4rem" fill="currentColor"
								...
								<div class="mb-5">
									<h2 class="color-900 text-center">A strong English
										foundation today, opens vast doors to your future tomorrow.</h2>
								</div>
								<!-- Image block -->
								<div class="">
									<img
										src="${pageContext.request.contextPath}/dist/assets/images/login-img.svg"
										alt="login-img">
								</div>
							</div>
						</div>
								...
								<form class="row g-1 p-3 p-md-4">
									...
									<div class="col-12">
										<div class="mb-2">
											<label class="form-label">Họ tên</label> <input type="text"
												name="hoten" class="form-control form-control-lg"
												placeholder="Họ tên">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="mb-2">
											<label class="form-label">Mật khẩu</label> <input
												...
												class="form-control form-control-lg" placeholder="8+ ký tự">
										</div>
									</div>
									<div class="col-12">
										<div class="mb-2">
											...
											<div id="passwordError"
												style="color: red; display: none; font-size: 0.9rem;">Mật
												khẩu không khớp. Vui lòng nhập lại.</div>
										</div>
									</div>
									<div class="col-12">
										<div class="form-check">
											<input class="form-check-input" type="checkbox" value=""
												...
												class="form-check-label" for="flexCheckDefault"> Tôi
												đồng ý với <a href="#" title="Terms and Conditions"
									...
									<div class="col-12 text-center mt-4">
										<!--  <a href="auth-signin.html"
											...
											alt="SIGNUP">Đăng ký</a>-->
											<button type="submit" class="btn btn-lg btn-block btn-light lift text-uppercase">ĐĂNG KÝ</button>
									</div>
									<div class="col-12 text-center mt-4">
										<span class="text-muted">Bạn đã có tài khoản? <a
											href="${pageContext.request.contextPath}/signin"
											title="Sign in" class="text-secondary">Đăng nhập</a></span>
									</div>
								</form>
								<!-- End Form -->
							</div>
