									...
									<ul
										...
										<li class="nav-item"><a class="nav-link"
											data-bs-toggle="tab" href="#Started-list" role="tab">Đang
												diễn ra</a></li>
										<li class="nav-item"><a class="nav-link"
											data-bs-toggle="tab" href="#Approval-list" role="tab">Sắp mở</a></li>
										<li class="nav-item"><a class="nav-link"
										...
										<div
											...
											<div class="card">
												<div class="card-body">
													...
													<% long thoiGianKhoaHoc = khoaHoc.getThoiGianKhoaHoc(khoaHoc.getKhoahoc_ngaybatdau(), khoaHoc.getKhoahoc_ngayketthuc()); %>
													
													<div class="row g-2 pt-4">
														
														<div class="col-6">
															<div class="d-flex align-items-center">
																<i class="icofont-sand-clock"></i> <span class="ms-2"><%=thoiGianKhoaHoc %> tháng</span>
															</div>
														</div>
														<div class="col-6">
															<div class="d-flex align-items-center">
													...
													<%
													double tienDo = khoaHoc.getTienDo();
													String tienDoStr = String.format("%.2f", tienDo);
													%>
													<div
														class="d-flex align-items-center justify-content-between mb-2">
														<h4 class="small fw-bold mb-0">Tiến Độ</h4>
														<span class="small light-danger-bg  p-1 rounded"><i
															class="icofont-ui-clock"></i> <%=khoaHoc.getSoNgayConLai() %> ngày còn lại</span>
													</div>
													<div class="progress" style="height: 8px;">
														<div class="progress-bar bg-secondary" role="progressbar"
															style="width: <%= tienDoStr %>%" aria-valuenow="<%= tienDoStr %>" aria-valuemin="0"
			...
			<div class="modal fade" id="readLopHoc" tabindex="-1"
				...
				<div class="modal-dialog modal-dialog-centered modal-xl ">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-dark w-sm-100"
								data-bs-toggle="modal" data-bs-target="#createLopHoc" data-khoahoc-id="">
