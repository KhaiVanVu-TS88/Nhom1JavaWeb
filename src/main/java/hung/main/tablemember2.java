 ...
 */
@WebServlet("/tablemember2")
public class tablemember2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	sidebar.vitri = "tablemember2";
    	getServletContext().setAttribute("sharedValue", "Giáo viên");
        ...
        out.append("<h3 class=\"fw-bold mb-0\">Danh sách giáo viên</h3>");
        out.append("<div class=\"col-auto d-flex w-sm-100\">");
        out.append("<button type=\"button\" class=\"btn btn-dark btn-set-task w-sm-100\" data-bs-toggle=\"modal\" data-bs-target=\"#addholiday\"><i class=\"icofont-plus-circle me-2 fs-6\"></i>Thêm giáo viên</button>");
        out.append("</div>");
        out.append("</div>");
        out.append("</div>");
        ...
        user u = new userImpl();
        ArrayList<NguoiDungObject> items = u.getUsers(null, 0, (byte)0,"Giáo viên");
